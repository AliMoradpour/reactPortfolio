        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <a href="mailto:mr.mrdp@yahoo.com" className="contact_button">
                Write Me
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">939-367-3709</span>

              <a
                href="https://api.whatsapp.com/send?phone=+989393673709&text=Hello, more information!
"
            ...
            <div className="contact_card">
              ...
              <h3 className="contact_card_title">Messegner</h3>
              <span className="contact_card_data">user.f2425</span>
